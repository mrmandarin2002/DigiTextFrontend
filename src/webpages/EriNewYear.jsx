...
class EriNewYear extends TemplateWebpage {
    ...
    render(){
        ...
        return(
            <div>
                <img style = {{position : 'absolute', opacity : this.state.opacity}} className = "eriImg" src = {this.state.cringeOverload ? cuteEri : eri} alt = "Eri" height = {this.props.controller.state.windowHeight} width = {this.props.controller.state.windowWidth}/>
                <Container>
                    <Row>
